...
rm -f "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_strength.gp"

cd ~/MolecCav
make all MAIN=App_trnstn_int
echo -e "reset"                          >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_strength.gp"
echo -e "set term qt font \"Times, 12\"" >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_strength.gp"

...
#File2 = '/home/segaud/MolecCav/OUT/Spectrum_2p1D_wmat1.88565999E-02_DTpm4.99999987E-05_wcav1.88565999E-02_lamb3.00000003E-03.txt'
...
#--- Matter detuned DTmat = 15E-5
#File2 = '/home/segaud/MolecCav/OUT/Spectrum_2p1D_wmat1.88565999E-02_DTpm1.50000007E-04_wcav1.88565999E-02_lamb3.00000003E-03.txt'
#File3 = '/home/segaud/MolecCav/OUT/Spectrum_3p1D_wmat1.88565999E-02_DTpm1.50000007E-04_wcav1.88565999E-02_lamb3.00000003E-03.txt'
#--- Anar
...
#--- uncoupled
#File1 = '/home/segaud/MolecCav/OUT/Spectrum_2p1D_wmat1.88565999E-02_DTpm1.99999995E-05_wcav1.88565999E-02_lamb0..txt'
#--- Not a spectrum
...
#set ylabel 'N_{mat}'
#set zlabel 'Transition intensity [Arbitrary units]' #Coupling strength [a.u.]
#set yrange [0:2]
#set zrange [0.0:0.014]
#set view 0, 0
#set view 70, 0
#show view
...
#replot File3 u 1:3:2 w l lw 2 title '3p1D'
  ...
  #plot File1 u 1:($2+0.008) w l lw 2 title '1p1D'
  plot File1 u 1:2 w l lw 2 title '1p1D'
replot File2 u 1:2 w l lw 2 title '2p1D'
replot File1_anar u 1:2 w l lw 2 title '1p1D (Anhar)'
replot File2_anar u 1:2 w l lw 2 title '2p1D (Anhar)'
#replot File2 u 1:($2+0.004) w l lw 2 title '2p1D'

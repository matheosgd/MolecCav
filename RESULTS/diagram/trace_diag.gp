...
#set output "/home/msegaud/MolecCav/RESULTS/diagram_reso.png"
set grid
show grid

#set datafile separator ";"
set xlabel '(Sub)System'
set ylabel 'Frequency'
#set zlabel 'z'
#set title  'Resonance case'
unset xrange
unset yrange
#unset zrange
...
#### HOW TO USE : ####
#"Resonant" : please select bloc=0
#"Detuned"  : please select bloc=1
######################
set title 'Detuned case' 
bloc = 1
set yrange [0.005:0.013 + 0.0015*bloc]
set xrange [0:4]
set xtics
set errorbars small lw 4 lc 'dark-violet'
  plot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:3:6             w xerrorbars notitle #lc 'dark-violet' pointtype 5 pointsize 1.5 
replot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:4:6             w xerrorbars notitle #lc 'dark-violet' pointtype 5 pointsize 1.5
replot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:5:6             w xerrorbars notitle #lc 'dark-violet' pointtype 5 pointsize 1.5
replot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:3:xticlabels(2) w lines dt 2                           lc 'black' lw 1 notitle
replot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:4:xticlabels(2) w lines dt 2                           lc 'black' lw 1 notitle
replot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:5:xticlabels(2) w lines dt 2                           lc 'black' lw 1 notitle
replot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:3:7             w labels point                         pointtype -1 notitle
replot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:4:7             w labels point                         pointtype -1 notitle
replot '/home/msegaud/MolecCav/RESULTS/diagram.txt' every :::bloc::bloc u 1:5:7             w labels point                         pointtype -1 notitle

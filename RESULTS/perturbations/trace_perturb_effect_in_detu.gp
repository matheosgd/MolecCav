...
set title sprintf("Coupling strength = %g", lambda)
...
set key right bottom
  plot '/home/segaud/MolecCav/RESULTS/perturbations/perturb_effect_in_detu_out.txt' using 1:2 with points pointtype 14  pointsize 1.7 lc 'dark-violet' t 'E_{1,2} (variational)'
replot '/home/segaud/MolecCav/RESULTS/perturbations/perturb_effect_in_detu_out.txt' using 1:3 with points pointtype 14  pointsize 1.7 lc 'dark-violet' notitle #t 'E2'
replot '/home/segaud/MolecCav/RESULTS/perturbations/perturb_effect_in_detu_out.txt' using 1:4 with points pointtype 13 pointsize 1.6 lc 'sea-green' t 'E_{1,2} (perturbative)'
replot '/home/segaud/MolecCav/RESULTS/perturbations/perturb_effect_in_detu_out.txt' using 1:5 with points pointtype 13 pointsize 1.6 lc 'sea-green' notitle #t 'E2'

...
set title  'Intensities = f(Detuning) for fixed w_{mat}=w_{HF} [a.u.]'
...
set key left top #deplace legende (=key) en bas à droite /!\ penser à remettre en haut à la fin (cf derniere ligne)
  plot '/home/msegaud/MolecCav/RESULTS/transition_intensities.txt' every :::1::1 using 1:2 with points pointtype 7  pointsize 1.5 t 'Groud\_state -> 1'
replot '/home/msegaud/MolecCav/RESULTS/transition_intensities.txt' every :::1::1 using 1:3 with points pointtype 7  pointsize 1.5 t 'Groud\_state -> 2'
replot '/home/msegaud/MolecCav/RESULTS/transition_intensities.txt' every :::1::1 using 1:4 with points pointtype 9  pointsize 1.5 t 'Groud\_state -> 3'
replot '/home/msegaud/MolecCav/RESULTS/transition_intensities.txt' every :::1::1 using 1:5 with points pointtype 11 pointsize 1.5 t 'Groud\_state -> 4'

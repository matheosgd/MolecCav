...
rm -f "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"

cd ~/MolecCav
make all MAIN=App_trnstn_int
echo -e "reset"                          >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
echo -e "set term qt font \"Times, 12\"" >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
...
echo -e "set xrange [min:max]"                                            >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
echo -e "#set yrange [0.0249:0.049]"                                      >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
echo -e "#set key left top"                                               >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
echo -e "\nConv = 21947.46 # 1Ha = Conv.cm-1"                             >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
echo -e "Gam = 0.3/Conv  # 30cm-1"                                        >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
echo -e "set samples 999\nshow samples"                                   >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
echo -e "L(x, x_0, Gam) = ( Gam/(2*pi) ) / ( ((Gam**2)/4) + (x-x_0)**2 )" >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
...
#  GSto4="${Intensities:108:12}"
  ...
  echo -e "\noffset = 0 #$Detuning*1E12" >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"  
  if [ "$I" == "0" ]; then 
    echo -e "  plot ( ${GSto1}*L(x, ${Enrgy1}, Gam) + ${GSto2}*L(x, ${Enrgy2}, Gam) + offset) w l lw 2 t 'Detuning = $Detuning'" >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
  else 
    echo "replot ( ${GSto1}*L(x, ${Enrgy1}, Gam) + ${GSto2}*L(x, ${Enrgy2}, Gam) + offset) w l lw 2 t 'Detuning = $Detuning'" >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"
  fi

  echo -e "\n Done testing coupling strength"
done

echo -e "#\nset key left top" >> "/home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp"

gnuplot -p /home/segaud/MolecCav/RESULTS/trace_trnstn_int_detu.gp